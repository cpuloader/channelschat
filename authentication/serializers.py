...
class AccountSerializer(serializers.ModelSerializer):
    ...
    picture_mini = serializers.ImageField(max_length=None, allow_empty_file=False, 
            use_url=True, required=False, allow_null=True)
    ...
    class Meta:
        ...
        fields = ('id', 'email', 'username', 'created_at', 'updated_at',
                  ...
                  'confirm_password', 'picture', 'picture_mini', 'enabled', 'is_online')
    ...
    def update(self, instance, validated_data):
        ...
        #instance.picture_mini = validated_data.get('picture_mini', instance.picture)
        instance.save()
        password = validated_data.get('password', None)
